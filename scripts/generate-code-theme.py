...
vscode = {
    ...
    "tokenColors": [
        ...
        {"scope": ["constant.numeric", "constant.language", "constant.character"], "settings": {"foreground": syntax["number"]}},
        ...
        {"scope": ["punctuation", "meta.brace"], "settings": {"foreground": color("muted")}},
    ],
    "colors": {
        "editor.foreground": color("foreground"),
        "editor.background": color("background"),
